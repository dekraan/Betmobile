...
# Uitgefaseerd: dit vermenigvuldigde in-sample ROI terug de strength in.
# Op False geeft apply_calibration overal multiplier 1.0; rollback = True.
USE_STRENGTH_CALIBRATION = False
